...
const getContentFromArchivesRaw = (name: string): string =>
	fs.readFileSync("test/resources/archives/" + name).toString();
...
export {getContentFromArchives, clearDisk, getContentFromArchivesRaw};
